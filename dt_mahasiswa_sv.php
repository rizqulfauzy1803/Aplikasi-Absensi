...
$query = "INSERT INTO tb_mahasiswa set id='$id', nobp='$nobp', password='$password', nama='$nama', nohp='$nohp', email='$email', suratpernyataan='$suratpernyataan', universitas='$universitas', jurusan='$jurusan', prodi='$prodi', bidang='$bidang',tanggalmasuk='$tanggalmasuk', lamapkl='$lamapkl',tanggalselesai='$tanggalselesai'";
