            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="data_keterangan.php">
                                <i class="fas fa-table"></i>Data Approval
                            </a>
                        </li>
                        <!--<li>
                            <a href="map.html">
                            ...
                            <form action="dt_karyawan_sv.php" enctype="multipart/form-data" method="post">
                                ...
                                <table class="table table-borderless table-striped table-earning" >
                                         ...
                                         <tbody>
                                           ...
                                           <tr>
                                                <td>No Hp</td>
                                                <td><input type="text" autocomplete="off" maxlength="20" required="" class="form-control" name="nohp"></td>
                                            </tr>                                           
                                            <tr>
                                                <td>Email</td>
                                            ...
                                            <tr>
                                                <td>Universitas</td>
                                                <td><input type="text" class="form-control" required="" name="universitas" autocomplete="off"></td>
                                            </tr>
                                            <tr>
                                                <td>Jurusan</td>
                                            ...
                                            <tr>
                                                <td>Prodi</td>
                                                <td><input type="text" class="form-control" required="" name="prodi" autocomplete="off"></td>
                                            </tr>
                                            <tr>
                                                <td>Bidang</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" required="" name="tanggalselesai" autocomplete="off"></td>
                                            </tr>
                                            </tr>
